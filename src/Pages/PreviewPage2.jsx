...
import img1 from '../assets/gal8.png';

const PreviewPage2 = () => {
  const product = {
    title: "Blue Juliet's | Oversize Boxy T-shirt",
    rating: 4.5,
    price: 199.99,
    image: img1
  };
    ...
    <div className="container mx-auto p-4 font-sans pt-[15vh]">
      <div className="flex flex-col md:flex-row md:space-x-8">
        ...
        <div className="md:w-1/2">
          ...
          <a
            href='https://shopee.co.id/Boxy-Oversize-T-Shirt-Luxqo-Drei-Stay-Away-From-All-My-Juliet-i.1105153799.24505731090?sp_atk=2c37865a-f22c-4d07-9dc9-88bb914120d3'
