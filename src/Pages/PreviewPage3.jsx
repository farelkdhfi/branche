...
import img1 from '../assets/gal10.png';

const PreviewPage3 = () => {
  const product = {
    title: "N'Impressed | Oversize Boxy T-shirt",
    rating: 4.5,
    price: 199.99,
    image: img1
  };
    ...
    <div className="container mx-auto p-4 font-sans pt-[15vh]">
      <div className="flex flex-col md:flex-row md:space-x-8">
        ...
        <div className="md:w-1/2">
          ...
          <a
            href='https://shopee.co.id/Boxy-oversize-T-Shirt-Luxqo-Drei-No-One-Impressed-Me-i.1105153799.24608495602?sp_atk=f9777bb4-23f8-491c-8966-ac6233b7f049'
          ...
          <p className="text-gray-600 mt-4">
            Experience ultimate comfort and style with the N'Impressed Oversize Boxy T-shirt.
